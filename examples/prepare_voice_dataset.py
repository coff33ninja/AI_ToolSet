...
def main():
    ...
    parser.add_argument(
        "--speaker", type=int, default=0, help="speaker id used as the <id>_<index> filename prefix"
    )
    ...
    parser.add_argument(
        "--min-silence", type=float, default=0.5, help="silence gap (s) that separates segments"
    )
